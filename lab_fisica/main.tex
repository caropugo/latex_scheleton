...
%\documentclass[12pt,a4paper,times,jou]{apa7}
...
%\def \titulospanish {Generación de Fuerza y Movimiento mediante
...
%\author[1]{Carolina Rosa Pulido Gómez\thanks{crpulidog@unadvirtual.edu.co}}
...
%\affil[1]{ECBTI - Universidad Nacional Abierta y a Distancia}
...
\begin{abstract}
\noindent
En este espacio, relacione un resumen que no exceda las 500 palabras, aquí debe mencionar lo que abordó en la práctica experimental.
\vspace{\baselineskip} \\
\palabrasclave{Escriba entre 3 a 5 palabras clave que den el fundamento al documento.}
\end{abstract}
\vspace{5mm}
...
\begin{abstract}
\noindent
In this section, provide a summary that does not exceed 500 words. 
Here, you should mention the topics addressed in the experimental practice.
\vspace{\baselineskip} \\
\keywords{Write between 3 to 5 keywords that provide the foundation for the document.}
\end{abstract}
\vspace{5mm}
