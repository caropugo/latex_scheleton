...
\usepackage{authblk}
\usepackage[pdfborder={0 0 0},unicode]{hyperref}% For email addresses
...
\providecommand{\palabrasclave}[1]{\textbf{\indent\textit{Palabras clave:}} #1} % https://tex.stackexchange.com/a/137307/91816
