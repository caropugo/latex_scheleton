\section{Código fuente del sistema SICR}
\addcontentsline{toc}{section}{Anexo A: Código fuente del sistema SICR}
\lipsum[1-4]
...
\section{Diagrama esquemático del montaje}
\addcontentsline{toc}{section}{Anexo B: Diagrama esquemático del montaje}
\lipsum[5-7]
...
\addcontentsline{toc}{section}{Anexo C: Exa,ple of Appendix}
