...
\section{Análisis}
    ...
    \begin{itemize}
    		\item ¿Quién lo usa?
    		\item ¿Dónde está instalado?
    		\item ¿Cómo se instala?
    \end{itemize}
...
\section{Especificación del Hardware}

\subsection{Diagrama de Bloques}
Representación gráfica de los circuitos que lleva la PCB.

\subsection{Floor Plant}
Representación de acomodo de los circuitos dentro de la PCB.

\subsection{Descripción de Circuitos}
Explicación de funcionamiento individual de circuitos.

\subsection{Pinout}
Tabla de conexiones de circuito hacia el microcontrolador.

\section{Esquemático}

\begin{enumerate}
	\item Creación del Diagrama Electrónico.
	\item Agregar características a los símbolos (footprint, número de parte).
	\item Generación de netlist.
\end{enumerate}


\section{PCB Layout}

\subsection{Acomodo mecánico de componentes}

\subsection{Rooteo de la PCB}

\subsection{Validación del DRC}

\section{Acomodo mecánico}

\subsection{Revisión de Serigrafía}
